...
if ($request && $request.method !== 'OPTIONS') {
  ...
  if (signUrlVal) utils.write(signUrlVal, signUrlKey);
  if (signHeaderVal) utils.write(signHeaderVal, signHeaderKey);
  if (signBodyVal) utils.write(signBodyVal, signBodyKey);
